...
class CompanyController extends BaseController
{
    ...
    public function index(request $request)
    {
        ...
        $users = User::where('role_id',2)->where(function ($query) use ($ShowRecord) {
            if (!$ShowRecord) {
    ...
    public function store(Request $request)
    {
        ...
        \DB::transaction(function () use ($request) {
            ...
            if ($request->hasFile('identification')) {
                ...
                $filenameidentification = 'no_avatar.png';
            }

            if ($request->hasFile('criminal_case')) {

                $image = $request->file('criminal_case');
                ...
                $filenamecriminal_case = 'no_avatar.png';
            }
            ...
            $User->identification    = $filenameidentification;
            $User->criminal_case    = $filenamecriminal_case;
