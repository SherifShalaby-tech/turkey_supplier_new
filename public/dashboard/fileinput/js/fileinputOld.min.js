      ...
      _initTemplateDefaults: function () {
        ...
        (i =
          ...
          (f =
            ...
            H +
            '"><span class="kv-zoom-caption"></span> <span class="kv-zoom-size"></span></h6>\n      <div class="kv-zoom-actions"><button type="button" class="btn btn-sm btn-default btn-outline-secondary crop" id="crop" title=""><i class="fa-solid fa-crop" style="color: rgb(66, 66, 66);"></i>           </button> {rotate}{toggleheader}{fullscreen}{borderless}{close}</div>\n    </div>\n    <div class="floating-buttons"></div>\n    <div class="kv-zoom-body file-zoom-content {zoomFrameClass}"></div>\n{prev} {next}\n    <div class="kv-zoom-description"></div>\n  </div>\n</div>\n'),
          (W =
          ...
          (I =
            ' <input type="hidden" id="custId" name="imgname" value="{title}"><img src="{data}" class="file-preview-image kv-preview-data" name="image"  id="{title}" title="{title}" alt="{alt}"' +
            B +
            ">\n"),
          (A =
