<template>
  <div class="main-header">
    <div class="logo">
       <router-link to="/admin/app/dashboard">
          ...
          >
            <div class="dropdown-item d-flex" v-if="notifs_alert > 0">
              ...
              v-if="currentUserPermissions && currentUserPermissions.includes('Reports_quantity_alerts')">
               <router-link  tag="a" to="/admin/app/reports/quantity_alerts" >
                <p class="text-small text-muted m-0">
                  {{notifs_alert}} {{$t('MaterialQuantityAlerts')}}
                  </p>
               </router-link>
              </div>
            </div>
      ...
      <div class="dropdown">
        ...
        >
          ...
          <div class="dropdown-menu-right" aria-labelledby="userDropdown">
            ...
            <router-link to="/admin/app/profile" class="dropdown-item">{{$t('profil')}}</router-link>
            <router-link
              v-if="currentUserPermissions && currentUserPermissions.includes('setting_system')"
              to="/admin/app/settings/System_settings"
              class="dropdown-item"
