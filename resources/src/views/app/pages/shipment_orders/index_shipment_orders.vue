<template>
  <div class="main-content">
    <breadcumb :page="$t('shipmentOrders')" :folder="$t('shipmentOrders')"/>
  ...
  computed: {
    ...
    columns() {
      return [
        ...
        {
          label: this.$t("shipment_service"),
          field: "shipment_services",
          tdClass: "text-left",
          thClass: "text-left"
        },
  ...
  methods: {
    ...
    Get_Users(page) {
      ...
      axios
        ...
        .then(response => {
          this.shipment_orders = response.data.shipment_orders;
