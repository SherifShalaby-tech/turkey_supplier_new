<template>
  <div class="main-content">
    <breadcumb :page="$t('Meditations')" :folder="$t('Settings')"/>
        ...
        <template slot="table-row" slot-scope="props">
          ...
          <span v-else-if="props.column.field == 'image'">
            <b-img
              ...
              width="50"
              fluid
              :src="'/images/meditations/' + props.row.image"
              alt="image"
            ></b-img>
          </span>
        </template>
        ...
        <b-form @submit.prevent="Submit_Brand" enctype="multipart/form-data">
          <b-row>
            ...
            <b-col md="12">
              ...
              >
                <b-form-group :label="$t('meditationsTitle')">
                  <b-form-input
                    :placeholder="$t('meditationsTitle')"
  ...
  methods: {
    ...
    Get_Brands(page) {
      ...
      axios
        ...
        .then(response => {
          this.meditations = response.data.meditations;
    ...
    Create_Brand() {
      ...
      axios
        ...
        .then(response => {
          ...
          this.makeToast(
            "success",
            this.$t("Create.TitleMeditations"),
            this.$t("Success")
          );
        })
        .catch(error => {
    ...
    Update_Brand() {
      ...
      axios
        .post("meditations/" + self.ad.id, self.data)
        .then(response => {
           self.SubmitProcessing = false;
          Fire.$emit("Event_Brand");
          ...
          this.makeToast(
            "success",
            this.$t("Update.TitleMeditations"),
            this.$t("Success")
          );
        })
        .catch(error => {
    ...
    delete_by_selected() {
      this.$swal({
        ...
        if (result.value) {
          ...
          NProgress.set(0.1);
          axios
            .post("meditations/delete/by_selection", {
