        ...
        <b-form @submit.prevent="Submit_Category">
          <b-row>
            ...
            <b-col md="12">
              ...
              >
                <b-form-group :label="$t('Codelanguage')">
                  <b-form-input
                    :placeholder="$t('Enter_Code_language')"
            ...
            <b-col md="12">
              <validation-provider
                ...
                v-slot="validationContext"
              >
                <b-form-group :label="$t('Namelanguage')">
                  <b-form-input
                    :placeholder="$t('Enter_name_language')"
                    :state="getValidationState(validationContext)"
...
export default {
  ...
  computed: {
    columns() {
      return [
        {
          label: this.$t("Codelanguage"),
          field: "code",
          tdClass: "text-left",
          thClass: "text-left"
        },
        {
          label: this.$t("Namelanguage"),
          field: "name",
          tdClass: "text-left",
          thClass: "text-left"
        },
  ...
  methods: {
    ...
    Update_Category() {
      this.SubmitProcessing = true;
      axios
        .put("languages/" + this.category.id, {
          name: this.category.name,
          code: this.category.code
        })
        .then(response => {
    ...
    delete_by_selected() {
      this.$swal({
        ...
        if (result.value) {
          ...
          NProgress.set(0.1);
          axios
            .post("languages/delete/by_selection", {
