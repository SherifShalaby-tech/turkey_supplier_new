<template>
  <div class="main-content">
    <breadcumb :page="$t('TradeShow')" :folder="$t('Settings')"/>
        ...
        <template slot="table-row" slot-scope="props">
          ...
          <span v-else-if="props.column.field == 'image'">
            <b-img
              ...
              width="50"
              fluid
              :src="'/images/trade_show/' + props.row.image"
              alt="image"
            ></b-img>
          </span>
        </template>
        ...
        <b-form @submit.prevent="Submit_Brand" enctype="multipart/form-data">
          <b-row>
            ...
            <b-col md="12">
              ...
              >
                <b-form-group :label="$t('tradeshowTitle')">
                  <b-form-input
  ...
  methods: {
    ...
    Get_Brands(page) {
      ...
      axios
        ...
        .then(response => {
          this.trade_show = response.data.trade_show;
    ...
    Update_Brand() {
      ...
      axios
        .post("trade_show/" + self.ad.id, self.data)
        .then(response => {
           self.SubmitProcessing = false;
          Fire.$emit("Event_Brand");
    ...
    delete_by_selected() {
      this.$swal({
        ...
        if (result.value) {
          ...
          NProgress.set(0.1);
          axios
            .post("trade_show/delete/by_selection", {
