        ...
        <b-form @submit.prevent="Submit_User" enctype="multipart/form-data">
          <b-row>
            ...
            <b-col md="6" sm="12">
              ...
              <!-- Identification card -->
              <b-col md="6" sm="12">
                  <validation-provider name="Identification" ref="Identification" rules="mimes:image/*|size:200">
                      <b-form-group slot-scope="{validate, valid, errors }" :label="$t('IdentificationCard')">
                          <input
                              :state="errors[0] ? false : (valid ? true : null)"
                              :class="{'is-invalid': !!errors.length}"
                              @change="onFileSelectedIdentification"
                              label="Choose Identification"
                              type="file"
                          >
                          <b-form-invalid-feedback id="Identification-feedback">{{ errors[0] }}</b-form-invalid-feedback>
                      </b-form-group>
                  </validation-provider>
              </b-col>
              ...
              <!-- criminal case -->
              <b-col md="6" sm="12">
                  <validation-provider name="criminal_case" ref="criminal_case" rules="mimes:image/*|size:200">
                      <b-form-group slot-scope="{validate, valid, errors }" :label="$t('criminal_case')">
                          <input
                              :state="errors[0] ? false : (valid ? true : null)"
                              :class="{'is-invalid': !!errors.length}"
                              @change="onFileSelectedCriminalCase"
                              label="Choose criminal_case"
                              type="file"
                          >
                          <b-form-invalid-feedback id="Identification-feedback">{{ errors[0] }}</b-form-invalid-feedback>
                      </b-form-group>
