...
export default {
    ...
    Enter_order_Price : 'Enter order Price',
    Enter_order_Paid : 'Enter order Paid',
    OrderPricePaid : 'Order Price Paid',
    OrderAmountRest : 'Order Amount Rest',
    AddedBy : 'Added By',
    ...
    Successfully_Product_Created: 'Successfully Product Created And Enter That In Stock',
