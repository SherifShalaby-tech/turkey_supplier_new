...
export default {
    ...
    Orders : 'الاوردرات',
    AddOrder : 'اضافة اوردر',
    ordersList:'قائمة الاوردرات',
    OrderImage : 'صورة الاوردر',
    CodeOrder : 'كود الاوردر',
    OrderPrice : 'سعر الاوردر',
    Enter_order_Price : 'أدخل سعر الاوردر',
    Enter_order_Paid : 'أدخل المبلغ المدفوع',
    OrderPricePaid : 'المبلغ المدفوع',
    OrderAmountRest : 'المبلغ المتبقي',
    AddedBy : 'أضيف بواسطة',
    ClientName : 'أسم العميل',
    ChooseClient : 'أختر العميل',
    Notes : 'ملاحظات',
    Materials : 'الخامات',
    AddMaterial : 'أضافة خامات',
    materialsList : 'قائمة الخامات',
    Receipt:'الإيصال',
    ...
    Successfully_Product_Created: 'تم اضافة المنتج ويجب عليك ادخاله في المخزن',
    ...
    Enter_Material_Cost: 'أدخل تكلفة الخامة',
    Enter_Stock_alert: 'أدخل تنبيه المخزون',
    Choose_Unit_Material: 'اختر وحدة الخامة',
    Enter_Product_Price: 'أدخل سعر بيع المنتج',
    Enter_Name_Material: 'أدخل اسم الخامة',
    ...
    CodeMaterial: 'رمز الخامة',
    Categorie: 'التصنيف',
    SubCategorie: 'التصنيف الفرعي',
    Name_Material: 'إسم الخامه',
    ...
    MaterialDetails: 'تفاصيل الخامه',
    //filters
    All: 'الكل',
    EditMaterial: 'تعديل الخامه',
    ...
    Addition: 'إدخال الى المخزن',
    Subtraction: 'إخراج الى الرف',
    Damage:'إتلاف',
    profil: 'الملف الشخصي',
    logout: 'تسجيل الخروج',
    ...
    ProductPrice: 'سعر بيع المنتج',
    UnitMaterial: 'خامة الوحدة',
    ...
    Recieved: 'المستلمة',
    Sent: 'المرسلة',
    MaterialQuantityAlerts: 'تنبيهات كمية الخامات',
