                ...
                <div class="row isotope-grid">
                    ...
                    @foreach($sellers as $seller)
                        <div class="col-sm-6 col-md-4 col-lg-3 col-6 p-b-35 isotope-item women" >
                            <div class="block2 " style=" width: 100%;   padding:10px 20px; height: auto;
                            filter: drop-shadow(5px 5px 5px rgba(0,0,0,0.3));">
                                <div class="block2-pic hov-img0">
                                    <a href="{{ route('supplier.profile', $seller->id) }}">
                                        @if($seller->firstMedia)
                                            <img src="{{ asset('images/companies/'.$seller->firstMedia->file_name) }}" class="img-fluid w-100"
                                                style="max-width: 100%;  height:266px ;width: 100% !important;
                                            background-size: cover;
                                            background-repeat: no-repeat;
                                            background-position: 50% 50%;
                                            border-radius: 7px;" >
                                            @else
                                               <img src="{{ asset('images/no-image.png') }}" alt="{{ $seller->name }}" class="img-fluid w-100"
                                               style="max-width: 100%;  height: 266px ;width: 100% !important;
                                               background-size: cover;
                                               background-repeat: no-repeat;
                                               background-position: 50% 50%;
                                ...
                                <div class="block2-txt flex-w flex-t p-t-14">
                                    <div class="block2-txt-child1 flex-col-l ">
                                        <a href="{{ route('supplier.profile', $seller->id) }}" class="stext-106 cl3 hov-cl1 trans-04 js-name-b2 p-b-6 card-title-name">
                                            {{$seller->name}}
                                        </a>
                                    </div>
                                </div>
                                    ...
                                    <div class="block2-pic hov-img0">
                                        <a href="{{ route('supplier.profile', $product->company->phone) }}">
                                            @if($product->company->firstMedia)
                                                <img src="{{ asset('images/companies/'.$product->company->firstMedia->file_name) }}" class="img-fluid w-100"
                                                    style="max-width: 100%;  height: 266px ;width: 100% !important;
                                                background-size: cover;
                                                background-repeat: no-repeat;
                                                background-position: 50% 50%;
                                                border-radius: 7px;" >
                                            @else
                                                <img src="{{ asset('images/no-image.png') }}" alt="{{ $product->company->name }}" class="img-fluid w-100"
                                                    style="max-width: 100%;  height: 266px ;width: 100% !important;
                                                background-size: cover;
                                                background-repeat: no-repeat;
                                                background-position: 50% 50%;
                                    ...
                                    <div class="block2-txt flex-w flex-t p-t-14">
                                        <div class="block2-txt-child1 flex-col-l ">
                                            ...
                                            <span class="stext-105 cl3">
                                                <a href="{{ route('supplier.profile', $product->company->phone) }}" class="btn  wobble-bottom"
                                                style="color: #fff;background-color: #3797b1; border:none; font-family: 'CustomFont';">
                                ...
                                filter: drop-shadow(5px 5px 5px rgba(0,0,0,0.3));">
                                    <div class="block2-pic hov-img0">
                                        <a href="{{ route('supplier.profile', $comp->phone) }}">
                                            @if($comp->firstMedia)
                                                <img src="{{ asset('images/companies/'.$comp->firstMedia->file_name) }}" class="img-fluid w-100"
                                                     style="max-width: 100%;  height: 266px ;width: 100% !important;
                                                    background-size: cover;
                                                    background-repeat: no-repeat;
                                                    background-position: 50% 50%;
                                                    border-radius: 7px;" >
                                            @else
                                                <img src="{{ asset('images/no-image.png') }}" alt="{{ $comp->name }}" class="img-fluid w-100"
                                                     style="max-width: 100%;  height: 266px ;width: 100% !important;
                                                    background-size: cover;
                                                    background-repeat: no-repeat;
                                                    background-position: 50% 50%;
                                    ...
                                    <div class="block2-txt flex-w flex-t p-t-14">
                                        <div class="block2-txt-child1 flex-col-l ">
                                            ...
                                            <span class="stext-105 cl3">
                                                    <a href="{{ route('supplier.profile', $comp->phone) }}" class="btn  wobble-bottom"
                                                       style="color: #fff;background-color: #3797b1; border:none; font-family: 'CustomFont';">
                                                       {{$comp->name}}</a>
                                                </span>
                                        </div>
