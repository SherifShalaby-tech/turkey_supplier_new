        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item mr-auto"><a class="navbar-brand" href="#"><img class="brand-logo" alt="modern admin logo"
                    ...
                    src="{{ asset('images/logo/'.App\Models\Setting::first()->logo)}}"
                    >
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"><span class="mr-1 user-name text-bold-700">{{ Auth::user()->name }}</span><span class="avatar avatar-online">
                        ...
                        @if(Auth::guard('company')->user())
                            @if(Auth::guard('company')->user()->firstMedia)
                            <img src="{{ asset('images/companies/' . Auth::guard('company')->user()->firstMedia->file_name) }}"
                                class="rounded mr-75" alt="{{ Auth::guard('company')->user()->name }}" height="64" width="64">
                            @endif
                        @endif
                        <i></i></span></a>
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <div class="ml-2">
                                <a class="dropdown-item" href="{{ route('website.index') }}"><i class="ft-user"></i> {{ __('custom.mysite') }}</a>
                            </div>
                                <a class="dropdown-item" href="{{ route('logout') }}"
                                onclick="event.preventDefault(); document.getElementById('logout-form').submit();" >
                                    <i class="ft-power"></i> {{ __('custom.logout') }}
                                </a>
                            ...
                            @if(Auth::guard('company')->user())
                                ...
                                <div class="ml-2">
                                    ...
                                    <a class="dropdown-item" href="{{route('web.logout')}}">
                                        <i class="ft-power"></i> {{trans('custom.logout')}}</a>
                                </div>
                            @endif
                            ...
                            <div class="ml-2">
                                <span><i class="fa fa-lock"></i></span>
                                <a class="dropdown-item" href="{{route('web.clerklogout')}}">
                                    <i class="ft-power"></i> {{trans('custom.logout')}}</a>
                            </div>
                        @endif
