...
@section('title', __('aboutnew.editabout'))
@section('css')
@endsection
@section('content')
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">{{ __('aboutnew.editabout') }}</h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{ route('admin.aboutnews.update', $aboutnew->id) }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <input type="hidden" name="id" value="{{ $aboutnew->id }}">
                                            <div class="form-group col-md-12 mb-2">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="projectinput1">{{ __('aboutnew.desc') }}</label>
                                                            <input type="text" class="form-control tinymce" name="subject"
                                                                value="{{ $aboutnew->subject}}"
                                            ...
                                            <div class=" col-md-6 mb-2">
                                                <div class="form-group">
                                                    ...
                                                    <div class="">
                                                        <input type="file" class="form-control img" name="image" accept="image/*" />
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    @if($aboutnew->image)
                                                      <img src="{{ asset('images/about_us/'.$aboutnew->image) }}"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="status" class="form-control">
                                                    ...
                                                    <option value="1" {{ old('status',$aboutnew->status) == '1' ? 'selected' : null }}>{{ __('aboutnew.active') }}</option>
                                                    <option value="0" {{ old('status',$aboutnew->status) == '0' ? 'selected' : null }}>{{ __('aboutnew.unactive') }}</option>
                                                </select>
