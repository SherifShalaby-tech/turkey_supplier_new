                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <form action="{{ route('admin.mediations.update', $mediation->id) }}" method="post" autocomplete="off" enctype="multipart/form-data">
                                            @csrf
                                            @method('put')
                                            <div class="modal-body">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="projectinput2" class="form-control"  name="title"
                                                                   value="{{ old('title',$mediation->title) }}" placeholder="title">
                                                        </div>
                                                        @error('title')
                                                ...
                                                <div class="col-md-12">
                                                    <button style="height: 40px;" class="btn btn-primary"
                                                            ...
                                                            data-target="#translation_table_mediation" aria-expanded="false"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea id="projectinput2" class="form-control tinymce"  name="description"
                                                                      placeholder="{{trans('products.description')}}">{{ $mediation->description }}</textarea>
                                                        </div>
                                                        @error('description')
                                                        <p class="text-danger" style="font-size: 12px">{{ $message }}</p>
                                                        @enderror
