...
@section('title',__('contactSuppliers.contactSuppliers'))
@section('css')
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">{{trans('contactSuppliers.contactSuppliers')}}</h3>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{trans('contactSuppliers.allcontactSupplier')}}</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body card-dashboard">
                                    <table class="table table-striped table-bordered " id="contactSuppliers-table">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>{{trans('contactSuppliers.contactSupplierName')}}</th>
                                                <th>{{trans('contactSuppliers.supplierName')}}</th>
                                                <th>{{trans('contactSuppliers.userName')}}</th>
                                                <th>{{trans('site.created_at')}}</th>
                                                <th>{{trans('contactSuppliers.datatable')}}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach ($contactSuppliers as $contactSupplier)
                                            <tr>
                                                <th>{{ $loop->iteration }}</th>
                                                <td>{{ $contactSupplier->name }}</td>
                                                <td>{{ $contactSupplier->supplier->name ?? null}}</td>
                                                <td>{{ $contactSupplier->user->name ?? null}}</td>
                                                <td>{{ $contactSupplier->created_at() }}</td>
                                                <td class="d-flex gap-2">
                                                    @include('Admin.contact_supplier.data_table.actions')
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
...
<html class="loading"  >
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset('dashboard/app-assets/css-rtl/pages/app-email.css') }}">
        <style>
            .card.shadow-none.border.rounded {
                display: none;
            }
        </style>
    </head>
    <body class="vertical-layout vertical-menu-modern content-left-sidebar email-application  fixed-navbar" data-open="click"
                    ...
                    <div class="sidebar-content email-app-sidebar d-flex">
                        ...
                        <div class="email-app-menu">
                            ...
                            <div class="sidebar-menu-list">
                                <!-- sidebar menu  -->
                                <div class="list-group list-group-messages">
                                    <a href="{{ route('admin.contactSuppliers.index') }}" class="list-group-item " id="inbox-menu">
                                        <div class="d-inline mr-25">
                                            <i class="ft-mail"></i>
                                        </div>
                                        {{ __('contactSuppliers.messages') }}
                                     ...
                                     <a href="{{route('admin.contactSuppliers.indexSend')}}" class="list-group-item active">
                                        <div class="d-inline mr-25">
                                            <i class="ft-play"></i>
                                        </div>
                        ...
                        <div class="email-app-area">
                            ...
                            <div class="email-app-list-wrapper">
                                <div class="email-app-list">
                                        ...
                                        <div class="action-left d-flex align-items-center">
                                            ...
                                            <ul class="list-inline m-0 d-flex">
                                                <li class="list-inline-item mail-delete">
                                                    ...
                                                    <button type="button" class="btn btn-icon action-icon" style="margin-right: 10px"
                                                    id="btn_delete_all" data-toggle="modal"
                                                    data-target="#bulkdelete" >
                                                    <i class="ft-trash-2"></i>
                                                    {{ __('contactSuppliers.bulkdelete') }}
                                                </button>
                                                </li>
                                                {{-- <li class="list-inline-item mail-unread">
                                                    <button type="button" class="btn btn-icon action-icon">
                                    ...
                                    <div class="email-user-list list-group">
                                        @forelse ($contactSuppliers as $contactSupplier)
                                            <div type="button"  data-toggle="modal" data-target="#show{{ $contactSupplier->id }}">
                                                <ul class="users-list-wrapper media-list">
                                                    {{-- <li class="media mail-read">
                                                        <div class="user-action">
                                                            <div class="checkbox-con mr-25">
                                                        ...
                                                        <li class="media">
                                                            <div class="user-action">
                                                                <div class="checkbox-con mr-25">
                                                                    <div class="custom-control custom-checkbox">
                                                                        {{-- <input type="checkbox" class="custom-control-input" id="checkboxsmall3"> --}}
                                                                        <input type="checkbox" value="{{ $contactSupplier->id }}" name="delete_select" id="delete_select">
                                                                        {{-- <label class="custom-control-label" for="checkboxsmall3"></label> --}}
                                                                    </div>
                                                                </div>
                                                                {{-- <span class="favorite">
                                                            ...
                                                            <div class="media-body">
                                                                <div class="user-details">
                                                                    ...
                                                                    <div class="mail-meta-item">
                                                                        <span class="float-right">
                                                                            <span class="mail-date">{{ $contactSupplier->created_at() }}</span>
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                                <div class="mail-message">
                                            ...
                                            @include('Admin.contact_supplier.data_table.actions')
                                            @include('Admin.contact_supplier.modalsms')
                                        @empty
                                            <div class="no-results">
                                                <i class="ft-info font-large-2"></i>
                                                <h5>No Items Found</h5>
                                        ...
                                        <div class="float-right">
                                            {!! $contactSuppliers->appends(request()->all())->links() !!}
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <script src="{{ asset('dashboard/app-assets/js/scripts/pages/app-email.js')}}"></script>
        <script>
            $(function() {
