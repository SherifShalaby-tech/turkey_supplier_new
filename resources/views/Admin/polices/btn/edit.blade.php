<!-- Modal -->
<div class="modal fade" id="edit{{ $police->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.polices.update', $police->id) }}" method="post" autocomplete="off" >
                @csrf
                @method('put')
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="projectinput2" class="form-control"  name="title"
                                       value="{{ old('title',$police->title) }}" placeholder="{{trans('polices.title')}}">
                            </div>
                            @error('title')
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control"  name="description" >
                                    {{ old('description',$police->description) }}
                                </textarea>
                            </div>
                            @error('description')
                            <p class="text-danger" style="font-size: 12px">{{ $message }}</p>
