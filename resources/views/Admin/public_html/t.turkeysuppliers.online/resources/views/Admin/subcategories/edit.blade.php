                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form  id="form_row" class="form" action="{{ route('admin.subcategories.update','test') }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                                                ...
                                                                <div class="row mx-0"
                                                                    ...
                                                                    <div class="col-10 offset-1">
                                                                        <div class="preview-images-container">
                                                                            @if($subcategory)
                                                                                <div id="preview{{ $subcategory->id }}" class="preview">
                                                                                    @if ($subcategory->image)
                                                                                        <img src="{{ asset('images/sub_categories/' . $subcategory->image) }}"
                                                                                             id="img{{  $subcategory->id }}"   alt="">
                                                                                    @else
                                                                                    ...
                                                                                    <button type="button"
                                                                                            ...
                                                                                            id="deleteBtn{{ $subcategory->id }}"
                                                                                            class="fas fa-trash"></i>
                                                                                    </button>
                                                                                    <button type="button"
                                                                                            data-toggle="modal"
                                                                                            id="cropBtn{{ $subcategory->id }}"
...
@push("js")
    ...
    <script>
        ...
        @if($subcategory)
        document.getElementById("cropBtn{{ $subcategory->id }}").addEventListener('click', () => {
            setTimeout(() => {
                launchImagesCropTool(document.getElementById("img{{ $subcategory->id }}"));
            }, 500);
        });

        document.getElementById("deleteBtn{{ $subcategory->id }}").addEventListener('click', () => {
            {{--if (window.confirm('Are you sure you want to delete this image?')) {--}}
            {{--    $("#preview{{ $subcategory->id }}").remove();--}}
            {{--}--}}
