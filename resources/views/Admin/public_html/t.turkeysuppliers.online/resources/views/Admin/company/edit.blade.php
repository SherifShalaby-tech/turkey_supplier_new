...
@section('title', __('company.editcompany'))
@section('css')
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">{{ __('company.editcompany') }}</h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form id="form_row" class="form" action="{{ route('admin.companies.update', $company->id) }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                                            ...
                                                            <div class="col-10 offset-1">
                                                                <div class="preview-images-container">
                                                                    @if($company->media()->count() > 0)
                                                                        @foreach($company->media as $index=>$media)
...
{{--                                                        <input type="file" id="company-images" class="@error('images') is-invalid @enderror form-control file-input-overview" name="images[]" multiple />--}}
{{--                                                    </div>--}}
                                                </div>
                                                @error('images')
                                                    <p class="text-danger" style="font-size: 12px">{{ $message }}</p>
