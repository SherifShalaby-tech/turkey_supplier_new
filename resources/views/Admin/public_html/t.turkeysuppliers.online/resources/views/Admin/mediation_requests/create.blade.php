...
@section('title',trans('mediation_request.newmediation_requests'))
@section('css')
@endsection
@section('content')
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">{{ trans('mediation_request.newmediation_requests') }}</h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form action="{{route('admin.MediationRequest.store')}}" method="POST">
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-4">
