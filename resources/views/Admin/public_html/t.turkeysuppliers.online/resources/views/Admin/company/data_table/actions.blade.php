    <a href="{{ route('admin.companies.edit',$company->id) }}" class="btn btn-info btn-sm" target="_blank">   {{ trans('site.edit') }}</a>
    {{-- <a href="{{ route('admin.users.index',$company->id) }}" class="btn btn-primary btn-sm">   {{ trans('site.show') }}</a> --}}
    <a href="{{ route('admin.companies.showdata',$company->id) }}" class="btn btn-success btn-sm">   {{ trans('site.show') }}</a>
