...
@section('title',__('clerks.newclerk'))
@section('css')
@endsection
@section('content')
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form">{{ __('clerks.newclerk') }}</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form  class="form" action="{{ route('admin.clerks.store') }}" method="post" >
                                        @csrf
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-md-3">
                                                                    ...
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            @foreach($permissionMaps as $key => $value)
                                                                              <th>@lang('site.' . $value)
                                                                                {{-- زرار يعلم على العمود فى الصلاحيات  ************************************ --}}
