...
@section('title',trans('newcat.newcat'))
@section('css')
<style>
    th {
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">{{trans('newcat.newcat')}}</h3>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">{{trans('newcat.newcat')}}</h4>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-sm dtHorizontalExample" id="newcats-table" width="100%" cellspacing="0">
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th>{{trans('newcat.categoryname')}}</th>
