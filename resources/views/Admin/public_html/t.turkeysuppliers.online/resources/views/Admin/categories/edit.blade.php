                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form id="form_row" class="form" action="{{ route('admin.categories.update', 'test') }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea id="projectinput1" class="form-control tinymce" name="description">{{ old('description',$category->description) }}</textarea>
...
{{--                                                </div>--}}
                                            ...
                                            <div class="form-actions">
                                                <button id="sub-button-form" type="submit" class="btn btn-primary">
...
@push("js")
    ...
    <script>
        ...
        @if($category)
        document.getElementById("cropBtn{{ $category->id }}").addEventListener('click', () => {
            setTimeout(() => {
                launchImagesCropTool(document.getElementById("img{{ $category->id }}"));
            }, 500);
        });
        document.getElementById("deleteBtn{{ $category->id }}").addEventListener('click', () => {
            {{--if (window.confirm('Are you sure you want to delete this image?')) {--}}
            {{--    $("#preview{{ $category->id }}").remove();--}}
            {{--}--}}
            Swal.fire({
                title: '{{ __("site.Are you sure?") }}',
                text: "{{ __("site.You won't be able to delete!") }}",
